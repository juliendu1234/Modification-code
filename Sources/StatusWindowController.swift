...
class StatusWindowController: NSWindowController {
    ...
    private func createHeaderSection() -> NSView {
        ...
        subtitleLabel.font = NSFont.systemFont(ofSize: 21, weight: .light)
    ...
    private func createMappingAndSaveSection() -> NSView {
        ...
        NSLayoutConstraint.activate([
            ...
            mappingBox.heightAnchor.constraint(equalToConstant: 370),  // Changed from 310 to 340
    ...
    private func createMappingSection() -> NSView {
        ...
        let mappings: [(String, String, NSColor)] = [
            ...
            ("□", "Atterrissage", .systemIndigo),
            ("△", "Arrêt d'urgence", .systemPink),
            ("○", "Reset urgence", .systemPink),
            ...
            ("Options", "Déconnexion", .systemRed),
            ("↑", "Caméra avant", .systemGreen),
            ("↓", "Caméra bas", .systemGreen),
            ("←", "Enregistrement vidéo", .systemGreen),
            ("→", "Prendre photo", .systemGreen)
        ]
...
class GamepadVisualizerView: NSView {
    ...
    private func colorForButton(_ button: String) -> NSColor {
        ...
        case "PS": return .black
        case "LEFT_STICK", "RIGHT_STICK": return .systemCyan
    ...
    private func drawStickIndicator(context: CGContext, at position: CGPoint, xOffset: CGFloat, yOffset: CGFloat, isPressed: Bool, scale: CGFloat) {
        ...
        let stickColor = isPressed ? NSColor.systemRed : NSColor.systemCyan
